 ...
 *  2. Workflow Automation — split 50/50 (task list user-friendly)
 *  3. Semplifica Studio — split 50/50 invertito (web app & sites)
 *  Copy riscritta in voce umana (no em dash overuse, no AI vocab,
 *  no negative parallelism, no rule of three forzato). */
...
function VisualWorkflow() {
  const tasks = [
    { Icon: FileSpreadsheet, titolo: "Dati cliente nel CRM", sub: "Da email, automatico", done: true },
...
const AGENTI: Agente[] = [
  {
    ...
    desc: "Scrive ai contatti fermi nel CRM su WhatsApp, gestisce la conversazione, prenota la call.",
  ...
  },
  {
    ...
    desc: "Riceve le richieste, controlla la disponibilità, conferma e manda i reminder. Zero doppie prenotazioni.",
  ...
  },
  {
    ...
    desc: "Risponde al telefono in italiano. Qualifica la richiesta, prenota, gira la chiamata solo quando serve.",
    iconImage: "/agents/voice-box.png",
    href: "/voice-agents",
  },
  {
    nome: "QuoteBot",
    categoria: "B2B, da email a preventivo",
    desc: "Legge le email, capisce le richieste d'offerta, arricchisce i dati e genera il preventivo PDF.",
...
const STUDIO_FEATURES = [
  { Icon: Code2, titolo: "Web app su misura", desc: "Ordering, prenotazioni, dashboard. Costruita sul tuo flusso, non su un template." },
  { Icon: Workflow, titolo: "Siti e landing", desc: "Veloci, accessibili, fatti per convertire. Dalla prima impressione alla call." },
  { Icon: Bot, titolo: "Refactoring vibe-coded", desc: "Sistemiamo prototipi AI-generated e li portiamo in produzione, senza riscrivere tutto." },
  { Icon: GraduationCap, titolo: "Performance & SEO", desc: "Core Web Vitals curati e leggibili dai motori. Veloce per gli utenti, indicizzabile bene." },
];
      ...
      <div className="container-x">
        ...
        <Reveal className="mx-auto mb-20 max-w-3xl text-center md:mb-24">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-text-dim md:text-lg">
            Progettiamo e mettiamo in produzione sistemi AI che lavorano come un vero
            dipendente assunto. Niente template, niente promesse vuote, niente fuffa.
          </p>
        </Reveal>
        ...
        <div className="mx-auto max-w-6xl space-y-20 md:space-y-28">
            ...
            <div className="rounded-3xl border border-white/10 bg-surface/40 p-8 md:p-12">
              <div className="mx-auto mb-10 max-w-3xl text-center md:mb-14">
                ...
                <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-text-dim md:text-lg">
                  Creiamo sistemi conversazionali alimentati da AI generativa. Ogni agente
                  viene addestrato sui dati della tua azienda e impara a usare i tuoi
                  strumenti, come farebbe una persona nuova in team.
                </p>
              </div>
          ...
          {/* Pilastro 2: Workflow Automation — split 50/50 */}
          <Reveal>
            <div className="grid grid-cols-1 items-center gap-10 md:gap-14 lg:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-5 text-base leading-relaxed text-text-dim md:text-lg">
                  Ti aiutiamo a semplificare le operazioni interne automatizzando i flussi
                  di lavoro manuali come l&apos;inserimento dati, la creazione di report,
                  gestione dei social, gestione delle mail, risparmiando tempo e riducendo
                  gli errori.
                </p>
                <div className="mt-6 flex flex-wrap gap-2">
                  {["Inserimento dati", "Creazione report", "Gestione social", "Gestione email"].map(
                    (pill) => (
                      <span
                        key={pill}
          ...
          {/* Pilastro 3: Semplifica Studio — split 50/50 invertito */}
          <Reveal>
            <div className="grid grid-cols-1 items-center gap-10 md:gap-14 lg:grid-cols-2 lg:[&>*:first-child]:order-2">
              ...
              <div>
                <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-lime/25 bg-lime/[0.06] px-3 py-1">
                  <Code2 className="h-3.5 w-3.5 text-lime" />
                  <span className="text-[11px] font-semibold uppercase tracking-wider text-lime">
                    Semplifica Studio
                  </span>
                </div>
                ...
                <p className="mt-5 text-base leading-relaxed text-text-dim md:text-lg">
                  Studio è la nostra web-factory. Costruiamo siti, web app di ordering e
                  prenotazione, e sistemiamo prototipi AI-generated che non reggono la
                  produzione. Codice pulito sotto, design curato sopra. In giorni, non mesi.
                </p>

                {/* Mini grid feature Studio (ispirazione Lucent Studio) */}
                <ul className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
                  {STUDIO_FEATURES.map((f) => (
                    ...
                    >
                      <span className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg border border-lime/20 bg-lime/[0.08] text-lime">
                        <f.Icon className="h-4 w-4" />
                      </span>
                      <div>
                        <p className="text-sm font-semibold text-text">{f.titolo}</p>
                        <p className="mt-0.5 text-xs leading-relaxed text-text-dim">{f.desc}</p>
                      </div>
                    </li>
                  ))}
                </ul>
